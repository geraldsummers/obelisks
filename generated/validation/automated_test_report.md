...
Generated: 2026-07-01T20:02:41.208478837Z

Repo: `/home/dev/workspace`

Instance: `/tmp/btm-agent-burnt-smoke-3`
...
| Rank   | Test                                                                   | Detail             |
| ------ | ---------------------------------------------------------------------- | ------------------ |
| SHOULD | performance budget exceeded: engine and world performance log analysis | 528.03 ms > 250 ms |
## Passes
| Test                                    | Detail               |
| --------------------------------------- | -------------------- |
...
| spawn preparation budget                | 26478 ms <= 60000 ms |
| server tick-behind budget               | 0 warnings, max 0 ms |
| world save budget                       | 1236 ms <= 10000 ms  |
